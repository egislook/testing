var help = {
  ...
  date : function(type, date){
    ...
    if(type == 'standart' || type == 'full' || type == 'time'){
      var dd = date.getDate();
  ...
  dateFromNow : function(str, type){
    type = type || 'ms';
    var left = str;
    var num = parseInt(left);
    var msLeft = left.indexOf('minute')!=-1 ? num*60000 : left.indexOf('hour')!=-1 ? num*3600000 : num*86400000;
    return help.date(type, help.date('ms') + msLeft);
  },
